...
import {AppointmentRequestCard} from "@/app/(user)/appointment-request/_component/molecules/AppointmentRequestCard"
import {Skeleton} from "@/components/ui/skeleton"
import {CalendarX2} from "lucide-react"
import {
    AppointmentRequestFilterBadge,
    AppointmentRequestFilterBadgeProps
} from "@/app/(user)/appointment-request/_component/molecules/AppointmentRequestFilterBadge";
...
export default function AppointmentsRequestPage() {
    ...
    if (isLoading) {
        return (
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 pt-14">
